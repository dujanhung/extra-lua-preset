...
function variant_safeguard.is_vector(o) if!variant_safeguard.is_table(o)then return false end for i=1,#o do if!variant_safeguard.is_number(a[i])then return false end end return true end
